...
solver = caffe.SGDSolver('pascal_scribble/config/deeplab_largeFOV/solverwithcutloss_train.prototxt')
#solver = caffe.SGDSolver('pascal_scribble/config/deeplab_vgg16/solverwithncloss_train.prototxt')
#solver.net.copy_from('/home/mtang73/halhome/Disney/deeplab/exper/pascal_scribble/model/deeplab_vgg16/train_iter_9000.caffemodel')
solver.net.copy_from('pascal_scribble/model/deeplab_largeFOV/train_iter_9000.caffemodel')
training_net = solver.net

solver.step(1)

print 'nc loss', training_net.blobs['cut_loss'].data
