...
test_net = caffe.Net('voc12/config/deeplab_vgg16/test_val.prototxt','voc12/model/deeplab_vgg16/train_iter_20000.caffemodel', caffe.TEST)
...
data_dim = test_net.blobs['data_dim'].data
