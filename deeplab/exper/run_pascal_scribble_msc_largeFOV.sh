...
if [ ${RUN_TRAIN} -eq 1 ]; then
    ...
    #
    MODEL=${EXP}/model/${NET_ID}/init/train_iter_9000.caffemodel
    #
...
if [ ${RUN_TEST} -eq 1 ]; then
    ...
    for TEST_SET in val; do
				...
				MODEL=${EXP}/model/${NET_ID}/trainwithncloss1.6_iter_9000.caffemodel
				#MODEL=${EXP}/model/${NET_ID}/trainwithncloss1.2_1e-6_iter_$TEMP.caffemodel
				# partial cross entropy loss only
				#MODEL=${EXP}/model/${NET_ID}/init/train_iter_6000.caffemodel
				...
				#MODEL=${EXP}/model/${NET_ID}/trainwithncloss1.6_18_iter_$TEMP.caffemodel
