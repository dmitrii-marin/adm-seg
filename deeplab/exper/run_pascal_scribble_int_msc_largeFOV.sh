...
TRAIN_SET_SUFFIX=normalizedcut
...
if [ ${RUN_TRAIN} -eq 1 ]; then
    ...
    #
    MODEL=${EXP}/model/${NET_ID}/deeplab_largeFOV_$TRAIN_SET_SUFFIX.caffemodel
    #
...
if [ ${RUN_TEST} -eq 1 ]; then
    ...
    for TEST_SET in val; do
				...
				#MODEL=${EXP}/model/${NET_ID}/trainwithncloss0.2_iter_9000.caffemodel
				if [ ! -f ${MODEL} ]; then
